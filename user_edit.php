...
?>
    ...
    <table class="table">
      ...
      <tr>
        <th>Password</th>
        <td><input type="password" name="password" value="<?php echo $row['password'];?>" disabled required/></td>
      </tr>
       <tr>
        <th>Name</th>
      ...
      <tr>
       ...
       <tr>
        <th>Phone Number</th>
        <td><input type="text" name="phone_number" value="<?php echo $row['phone_number'];?>" required/></input></td>
      </tr>
