 <?php
  ...
  $title = "Bottoms";
  include('./assets/template/header_tables.php');
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                 ...
                 onclick="window.location.href='category_add.php'">
                        Add New Category
                        </button>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['category_name']; ?></td>
                        <td><button type="submit" name="edit" class="btn btn-primary btn-user btn-block"
                 onclick="window.location.href='category_edit.php?category_id=<?php echo $row['category_id']?>'">
                        Edit
                        </button></td>
                        <td><button type="submit" name="delete" class="btn btn-primary btn-user btn-block"
                 onclick="window.location.href='category_delete.php?category_id=<?php echo $row['category_id']?>'">
                        Delete
                        </button></td>
                    </tr>
                    <?php } ?>
